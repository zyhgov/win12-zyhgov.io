...
let nts = {
    'about': {
        cnt: `<p class="tit">Windows 12 网页版 张永豪 重制版</p>
            <p>Windows 12 网页版是一个开放源项目,<br />
            希望让用户在网络上预先体验 Windows 12,<br />
            zyhgov杖雍皓(张永豪)已进行部分重置,<br />
            已得到作者授权允许静态更改,未经授权,不许转载,<br />
            使用标准网络技术,例如 HTML, CSS 和 JS<br />
            此项目为虚构项目,绝不附属于微软,且不应与微软操作系统或产品混淆,<br />
    ...
    'feedback': {
        cnt: `<p class="tit">反馈</p>
            <p>我们非常注重用户的体验与反馈</p>
            <list class="new">
                <a class="a" onclick="window.open('mailto:zyh040410@outlook.com','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">在微软outlook上向我(张永豪)发送邮箱</a>
    ...
    'zyhgov': {
        cnt: `<p class="tit"><img src="./icon/zyhgov.svg" alt="" width="50px"/>ZYHGOV 系统中心 链接跳转</p>
            <p>暂时未实现嵌套页面，可直接点击链接跳转网页。</p>
            <list class="new">
                <a class="a" onclick="window.open('https://zyhgov-iegc5-3gdx78p260d3b261-1314221350.tcloudbaseapp.com/','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">使用腾讯云入口进入创新创业页面</a>
                <a class="a" onclick="window.open('https://zyhgov.gitee.io/iegc/','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">使用Gitee库入口进入创新创业页面</a>
                <a class="a" onclick="window.open('https://zyhgov-iegc5-3gdx78p260d3b261-1314221350.tcloudbaseapp.com/news/sqljs/cxcy000.html','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">创新创业指导委员会系统中心学号自动查询分组系统(腾讯云入口)</a>
                <a class="a" onclick="window.open('https://zyhgov.gitee.io/zyhgov.cn/','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">ZYHGOV引导页面(Gitee库入口)</a>
            </list>`,
        btn: [
            { type: 'main', text: '关闭', js: 'closenotice();' },
    ...
    'zyhgov-bz': {
        cnt: `<p class="tit"><img src="./icon/zyhgov-bz.svg" alt="" width="50px"/>ZYHGOV 系统中心 链接跳转</p>
            <p>暂时未实现嵌套页面，可直接点击链接跳转网页。</p>
            <list class="new">
                <a class="a" onclick="window.open('https://zyhgov-iegc5-3gdx78p260d3b261-1314221350.tcloudbaseapp.com/news/sqljs/cxcy000.html','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">创新创业指导委员会系统中心学号自动查询分组系统(腾讯云入口)</a>
                <a class="a" onclick="window.open('https://zyhgov.gitee.io/iegc/news/sqljs/cxcy000.html','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">创新创业指导委员会系统中心学号自动查询分组系统(Gitee入口)</a>

                <a class="a" onclick="window.open('#','_blank');" win12_title="在浏览器新窗口打开链接" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">创新创业表单分组提交(问卷网支持)</a>
            </list>`,
        btn: [
            { type: 'main', text: '关闭', js: 'closenotice();' },
            { type: 'cancel', text: '取消', js: 'closenotice();' }
...
let apps = {
    ...
    zyhgov: {
        ...
        load: () => {
            $('#win-zyhgov')[0].insertAdjacentHTML('afterbegin', '<iframe src="https://zyhgov.gitee.io/zyhgov.cn/" frameborder="0" style="width: 100%; height: 100%;" loading="lazy"></iframe>')
        }
    },
    defender: {
        init: () => {
        ...
        $.get('http://win12server.freehk.svipss.top/Chat?msg=' + encodeURIComponent(JSON.stringify(copilot.history))).then(rt => {
            ...
            if (r.length) {
                for (const i of r) {
                    ...
                    } else if (/{zyhgov win12}/.test(i)) {
                        shownotice('zyhgov');
                        rt = rt.replace(i, `<div class="action"><p class="tit">zyhgov</p><p class="detail">关于 Windows 12 网页版</p></div>`)
...
function setIcon() {
    ...
    <div class="b" ondblclick="shownotice('zyhgov');" ontouchstart="shownotice('zyhgov');;">
        <img src="icon/zyhgov-yuan.svg">
        <p>zyhgov系统中心</p>
    </div>
    <div class="b" ondblclick="shownotice('zyhgov-bz');" ontouchstart="shownotice('zyhgov-bz');;">
        <img src="icon/zyhgov-bz.svg">
        <p>zyhgov表组</p>
    </div>
    <span class="choose">
    </span>
